...
Не обрезанную версию таблицы ниже см. [на GitHub](https://github.com/Lex-is-BIM/renga_bri4ka/blob/main/docs/src/RENGA_BRI4KA_COMMANDLINEPREPROC.md)
...
| CREATE_ROOF         | Создать кровлю                         | (WKT_LINESTRING; THICKNESS)        |                                                                                                                                                                                                                                                                                    | 8.10      | ✅    |
